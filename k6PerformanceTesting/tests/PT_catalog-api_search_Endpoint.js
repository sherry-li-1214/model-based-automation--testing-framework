...
import { getTLSCertificate } from '@stepci/runner/dist/utils/auth';
...
export function handleSummary(data) {
  return {
    ...
    '../reports/summary3.json': JSON.stringify(data), //the default data object
    '../reports/summary3.html': htmlReport(data)
